...
class DidSaveTextDocumentFeature extends DocumentNotifiactions {
    constructor(client) {
        super(client, vscode_1.workspace.onDidSaveTextDocument, protocol_1.DidSaveTextDocumentNotification.type, (textDocument) => client.code2ProtocolConverter.asSaveTextDocumentParams(textDocument, this._includeContent), DocumentNotifiactions.textDocumentFilter);
    }
    register(data) {
...
class LanguageClient {
    ...
    createWorkspaceSymbolProvider(options) {
