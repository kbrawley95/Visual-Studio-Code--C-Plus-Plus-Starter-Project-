...
import { Message, ErrorCodes, ResponseError, RequestType, RequestType0, RequestHandler, RequestHandler0, GenericRequestHandler, NotificationType, NotificationType0, NotificationHandler, NotificationHandler0, GenericNotificationHandler, Trace, Event } from 'vscode-jsonrpc';
...
export declare class LanguageClient {
    ...
    private doSendRequest<P, R, E, RO>(connection, type, params, token?);
    private _doSendRequest<R>(connection, type, params);
    ...
    private initRegistrationHandlers(connection);
    ...
    private createCompletionProvider(connection, options);
    private createHoverProvider(connection, options);
    private createSignatureHelpProvider(connection, options);
    private createDefinitionProvider(connection, options);
    private createReferencesProvider(connection, options);
    private createDocumentHighlightProvider(connection, options);
    private createDocumentSymbolProvider(connection, options);
    private createWorkspaceSymbolProvider(connection, options);
    private createCodeActionsProvider(connection, options);
    private createCodeLensProvider(connection, options);
    private createDocumentFormattingProvider(connection, options);
    private createDocumentRangeFormattingProvider(connection, options);
    private createDocumentOnTypeFormattingProvider(connection, options);
    private createRenameProvider(connection, options);
    private createDocumentLinkProvider(connection, options);
}
